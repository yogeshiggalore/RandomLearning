...
void ESPAlexa::Update_Specified_File(uint8_t ui8ID){
    ...
    }else if(ui8ID == ALEXA_ENTROL_ID_INDEX){
        sEntrolRelayId = sString;
    }else if(ui8ID == ALEXA_ENTROL_NAME_INDEX){
        sEntrolRelayName = sString;
    }else{
...
void ESPAlexa::Update_All_Key_And_ID(void){
    ...
    sEntrolRelayId = EFile.Read_Data_From_File(sESPFiles[ALEXA_ENTROL_ID_INDEX]);
    EUtils.print("EntrolRelayId:");    
    EUtils.println(sEntrolRelayId);


    sEntrolRelayName = EFile.Read_Data_From_File(sESPFiles[ALEXA_ENTROL_NAME_INDEX]);
    EUtils.print("EntrolRelayName:"); 
    EUtils.println(sEntrolRelayName);
